export const tagName = 'cookie-police-bar';
export const isPoliceAccepted = 'isCookiePoliceAccepted';
export const isPoliceBarClosed = 'isCookiePoliceBarClosed';
...
export const defaultPoliceLink =
